...
var transcode = require('../csm/transcode.cjs');
...
function transcodeResponse(_ref) {
  ...
  const transcoder = transcode.createTranscoder({
    studioUrl,
    encodeSourceMapAtPath,
    logger
  });
...
exports.isContentSourceMapBody = isContentSourceMapBody;
exports.isResultBody = isResultBody;
