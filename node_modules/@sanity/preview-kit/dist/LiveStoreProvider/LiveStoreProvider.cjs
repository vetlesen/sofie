...
var jsonpath = require('../csm/jsonpath.cjs');
var sourcemap = require('../csm/sourcemap.cjs');
...
const LiveStoreProvider = react.memo(function LiveStoreProvider2(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(context.defineListenerContext.Provider, {
    ...
    children: [/* @__PURE__ */jsxRuntime.jsx(context.IsEnabledContext.Provider, {
      value: true,
      children
    }), turboSourceMap && /* @__PURE__ */jsxRuntime.jsx(Turbo, {
      cache: hooks.cache,
      client,
      setTurboIds,
      snapshots,
...
const QuerySubscription = react.memo(function QuerySubscription2(props) {
  ...
  react.useEffect(() => {
    ...
    async function effect() {
      ...
      if (!signal.aborted) {
        snapshots.set(utils.getQueryCacheKey(query, params), {
...
function turboChargeResultIfSourceMap(projectId, dataset, result, resultSourceMap) {
  ...
  return sourcemap.walkMap(result, (value, path) => {
    ...
    if (sourceDocument && sourceDocument._id) {
      ...
      const cachedValue = cachedDocument ? get__default.default(cachedDocument, jsonpath.parseNormalisedJsonPath(sourcePath + pathSuffix), value) : value;
...
module.exports = LiveStoreProvider$1;
//# sourceMappingURL=LiveStoreProvider.cjs.map
