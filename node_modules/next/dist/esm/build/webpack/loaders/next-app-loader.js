        ...
        for (const [parallelKey, parallelSegment] of parallelSegments){
          ...
          ${createMetadataExportsCode(metadata)}
            ...
            if (isNotFoundRoute && normalizedParallelKey === "children") {
                ...
                const notFoundPath = ((_definedFilePaths_find1 = definedFilePaths.find(([type])=>type === "not-found")) == null ? void 0 : _definedFilePaths_find1[1]) ?? "next/dist/client/components/not-found-error";
                subtreeCode = `{
          children: ['__PAGE__', {}, {
            page: [
