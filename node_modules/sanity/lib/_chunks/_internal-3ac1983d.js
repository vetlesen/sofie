...
async function getBuildAction() {
  const mod = await import('./buildAction-d71ef4a8.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-f19bb88d.js');
...
async function getDevAction() {
  const mod = await import('./devAction-cb665847.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-2cfcaab0.js');
  return mod.default;
}
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-b33d40ff.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-820708d7.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
//# sourceMappingURL=_internal-3ac1983d.js.map
